...
from ..armys import disturbarmy, tankarmy, initarmy, droparmy, homearmy
from sc2.ids.unit_typeid import UnitTypeId
from ..units import unitwrapper

class TankStrategy(strategy.Strategy):
    ...
    def on_start(self):    
        ...
        self.tankarmy = tankarmy.TankArmy(self.bot, self.bot.map.points[7], self.bot.map.points[8])
